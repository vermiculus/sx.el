...
(ert-deftest question-list-display ()
  (cl-letf (((symbol-function #'sx-request-make)
    ...
    (line-should-match
     "^\\s-+1\\s-+0\\s-+Focus-hook: attenuate colours when losing focus [ 0-9]+[ydhms]o? ago\\s-+\\[frames\\] \\[hooks\\] \\[focus\\]")
    (sx-question-list-next 5)
    (line-should-match
     "^\\s-+0\\s-+1\\s-+Babel doesn&#39;t wrap results in verbatim [ 0-9]+[ydhms]o? ago\\s-+\\[org-mode\\]")
    ...
    (line-should-match
     "^\\s-+2\\s-+1\\s-+&quot;Making tag completion table&quot; Freezes/Blocks -- how to disable [ 0-9]+[ydhms]o? ago\\s-+\\[autocomplete\\]")))
